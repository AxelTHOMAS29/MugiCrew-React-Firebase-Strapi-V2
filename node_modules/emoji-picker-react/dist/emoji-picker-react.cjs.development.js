...
function useUpdateSuggested() {
  var _React$useContext10 = React.useContext(PickerContext),
      suggestedUpdateState = _React$useContext10.suggestedUpdateState;
...
function queryScrollBody(root) {
  return root ? root.matches(asSelectors(ClassNames.scrollBody)) ? root : root.querySelector(ClassNames.scrollBody) : null;
}
...
function RenderCategory(_ref) {
  ...
  var _useActiveSkinToneSta = useActiveSkinToneState(),
      activeSkinTone = _useActiveSkinToneSta[0]; // Small trick to defer the rendering of all emoji categories until the first category is visible
...
function CssSearch(_ref) {
  ...
  return value ? React.createElement("style", null, "\n        .EmojiPickerReact button.epr-emoji:not([data-full-name*=\"" + getNormalizedSearchTerm(value) + "\"]) {\n          display: none;\n        }\n  ") : null;
}
...
function PickerRootElement(_ref2) {
  ...
  return React.createElement("aside", {
    className: clsx('EmojiPickerReact', 'epr-main', (_clsx = {}, _clsx[ClassNames.searchActive] = searchModeActive, _clsx['epr-dark-theme'] = theme === exports.Theme.DARK, _clsx)),
    ref: PickerMainRef,
    style: style
  }, children);
}
